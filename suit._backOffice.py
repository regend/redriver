...
import unittest
import sys
from src.backOffice.boAutoOrder import BoAutoOrder
from src.backOffice.boIndex import BoIndex
from src.backOffice.boPlacementSet import BoPlacementSet
...
def run_suit():
    ...
    suit = unittest.TestSuite([
        ...
        load_case(BoSponsor),
        load_case(BoAutoOrder),
        load_case(BoPlacementSet)
    ])
